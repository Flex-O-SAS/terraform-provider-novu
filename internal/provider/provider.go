...
var _ provider.ProviderWithFunctions = &NovuProvider{}
var _ provider.ProviderWithEphemeralResources = &NovuProvider{}
...
func (p *NovuProvider) EphemeralResources(ctx context.Context) []func() ephemeral.EphemeralResource {
...
func (p *NovuProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewEnvironmentsWithKeysDataSource,
		NewApiKeyDataSource,
...
func (p *NovuProvider) Functions(ctx context.Context) []func() function.Function {
